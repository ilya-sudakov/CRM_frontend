            ...
            <div className="main-window">
                <div className="main-window__list">
                    ...
                    {props.drafts.filter(draft => (
                        draft.number.toLowerCase().includes(props.searchQuery.toLowerCase()) ||
                        draft.name.toLowerCase().includes(props.searchQuery.toLowerCase()) ||
                        draft.location.toLowerCase().includes(props.searchQuery.toLowerCase())
                    )).map((draft, index) => {
