...
import "./SelectWorkItemMinimized.scss";
...
const SelectWorkItemMinimized = (props) => {
  ...
  return (
    <div className="select-work-item-mini">
      <div className="select-work-item-mini__input">
        <div className="select-work-item-mini__input_name main-form__input_name--header">
          {(props.defaultValue || fullName) && (
            <div className="select-work-item-mini__value">{props.defaultValue ? props.defaultValue : fullName}</div>
          )}
      ...
      {props.error === true && (
        <div
          className="select-work-item-mini__error"
          onClick={
            props.setErrorsArr
              ? () =>
                  props.setErrorsArr({
      ...
      <FormWindow
        title="Выбор работы"
        windowName="select-work-item-mini"
        id={props.id}
        content={
          <React.Fragment>
            <SearchBar
...
export default SelectWorkItemMinimized;
