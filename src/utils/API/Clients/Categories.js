...
export function getClientCategories() {
  return request({
    url: process.env.API_URL + '/api/v1/category/client/',
    method: 'GET',
  });
}
...
export function getSupplierCategories() {
  return request({
    url: process.env.API_URL + '/api/v1/category/supplier/',
    method: 'GET',
  });
}
...
export function getClientCategoryById(id) {
  return request({
    url: process.env.API_URL + '/api/v1/category/' + id,
    method: 'GET',
  });
}
...
//     return request({
//         url: process.env.API_URL + "/api/v1/category/" + categoryName,
//         method: "GET"
//     });
// }
...
export function addClientCategory(newCategory) {
  return request({
    url: process.env.API_URL + '/api/v1/category',
    method: 'POST',
