...
export function getStamp(signal) {
  return request({
    url: process.env.API_URL + '/api/v1/stamp/',
    method: 'GET',
    signal: signal,
  });
}
...
export function getStampsByStatus(status, signal) {
  return request({
    url: `${process.env.API_URL}/api/v1/stamp/status/${status}`,
    method: 'GET',
    signal: signal,
  });
}
...
export function getStampById(id) {
  return request({
    url: process.env.API_URL + '/api/v1/stamp/' + id,
    method: 'GET',
  });
}
...
export function addPartsToStamp(newPart) {
  return request({
    url: process.env.API_URL + '/api/v1/stamp/part/',
    method: 'POST',
...
export function editPartsOfStamp(newPart, id) {
  return request({
    url: process.env.API_URL + '/api/v1/stamp/part/' + id,
    method: 'PUT',
    body: JSON.stringify(newPart),
  });
}
...
export function editStampColor(color, id) {
  return request({
    url: process.env.API_URL + '/api/v1/stamp/color/' + id,
    method: 'PUT',
...
export function editStampPartColor(color, id) {
  return request({
    url: process.env.API_URL + '/api/v1/stamp/part/color/' + id,
    method: 'PUT',
    body: JSON.stringify(color),
  });
}
