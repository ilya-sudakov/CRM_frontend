      ...
      {props.categories.map((category, category_id) => (
        <React.Fragment>
              ...
              {props.userHasAccess &&
                props.userHasAccess(['ROLE_ADMIN', 'ROLE_MANAGER']) && (
                  <Link
                    ...
                    className="tableview_products__action"
                  >
                    Редактировать
                  </Link>
                )}
          ...
          <div
            id={category_id}
            className={
              isProductsHidden(category.id) === true
                ? 'tableview_products__categories tableview_products__categories--hidden'
                : 'tableview_products__categories'
            }
          >
            <div className="tableview_products__row tableview_products__row--header">
              ...
              (product, product_id) =>
                product.category === category.category && (
                  <div
                    key={product_id}
                    className={
                      'tableview_products__row tableview_products__row--odd'
                    }
                  >
                    ...
                    <div className="tableview_products__actions">
                      ...
                      {props.selectProduct && (
                        <div className="tableview_products__action tableview_products__action--double">
                          <div
                            data-id={product.id}
                            className="tableview_products__action tableview_products__action--continue"
                            onClick={() => {
                              props.selectProduct(product.id, product.name)
                            }}
                          >
                            <img
                              className="tableview_products__img"
                              src={plusContIcon}
                              alt=""
                            />
                          </div>
                          <div
                            data-id={product.id}
                            className="tableview_products__action tableview_products__action--close"
                            onClick={() => {
                              props.selectProduct(product.id, product.name)
                              props.setCloseWindow(!props.closeWindow)
                            }}
