                        ...
                        .map((item, index) => {
                            return <div className="main-window__list-item">
                                ...
                                <span><div className="main-window__mobile-text">Сайт: </div>
                                    {/* {item.site} */}
                                    <a className="main-window__link" href={item.site.split('//').length > 1 ? item.site : 'http://' + item.site} target="_blank">{item.site.split('//').length > 1 ? item.site.split('//')[1] : item.site}</a>
                                </span>
